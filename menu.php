    ...
    <nav>
      <div class="nav nav-tabs d-flex justify-content-center flex-wrap" id="nav-tab" role="tablist">
        <a class="nav-item hvr-underline-from-left" id="nav-items-tab" data-toggle="tab" href="#nav-items" role="tab"
          aria-controls="nav-items" aria-selected="true">Menu Items</a>
        <a class="nav-item hvr-underline-from-left" id="nav-packages-tab" data-toggle="tab" href="#nav-packages" role="tab"
          aria-controls="nav-packages" aria-selected="false">Packages</a>
      </div>
    </nav>
  </div>
  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade show active" id="nav-items" role="tabpanel" aria-labelledby="nav-items-tab">
      ...
      <article id="menu-items-list">
        ...
        <!-- Filter Form Here -->
        <form action="menu.php" method="get" id="filter-form" class="form-container text-center">
    ...
    <div class="tab-pane" id="nav-packages" role="tabpanel" aria-labelledby="nav-packages-tab">
