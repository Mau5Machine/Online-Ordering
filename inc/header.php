        ...
        <nav class="navbar navbar-expand-lg navbar-dark farm-blue-bg">
            ...
            <div class="collapse navbar-collapse" id="main-nav">
                ...
                <div class="form-inline my-2 my-lg-0">
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#orderModal" id="start-btn">Start
                        Order</button>
                                    ...
                                    <form action="" class="datetime-choose">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control mr-3" id="date" aria-describedby="date choose"
